                    ...
                    <div class="motivz-typo-wrap">
                        <figure class="motivz-jobdetail-list" style="padding:15px 15px 0 15px !important;">
                            <span class="motivz-jobdetail-listthumb"><small
                                        style="background-image: url(' @if($job['client']['logo']) {{asset('user/company_logo/'.$job['client']['logo'])}} @else {{ asset('/user/images/featured-img1.jpg') }} @endif');"></small></span>
                            <figcaption>
                                <h2>{{$job->job_title}}</h2>
...
=======
                                    <a href="javascript:void(0)" class="like-wrap" onclick="save_fav_job({!! $job['id'] !!})"><i @if(is_null($fav_check)) style="" @else style="color:tomato" @endif class="fa fa-heart icon_{!! $job['id'] !!}"></i></a>
>>>>>>> new mymotivz
