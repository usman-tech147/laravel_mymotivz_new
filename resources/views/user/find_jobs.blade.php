...
@section('content')
    ...
    <!--// Main Content \\-->
    <div class="motivz-main-content find-my-jobswrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="job-search-wrapper">
                            <div class="job-search">
                                <ul>
                                    <li class="title">
                                        <input type="text" id="search_job_title" name="job_title"
                                               placeholder="Job title or keyword"
                                               value="@if(!empty(Session::get('search_job_title'))){{trim(Session::get('search_job_title'))}}@endif">
                                    </li>
                                    <li class="location"><i class="icon-placeholder"></i>
                                        <input type="text" id="search_place" name="place" placeholder="City or area"
                                               value="@if(!empty(Session::get('search_location'))){!! Session::get('search_location') !!}@endif">
                                    </li>
                                    <li>
                                        <label>
                                        ...
                                        <a href="javascript:void(0)" class="advanc-serch">Filters</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="job-filters-top">
                                <ul>
                                    <li>
                                        <select class="form-control jobtype_filter" id="jobtype_filter"
                                                multiple="multiple" name="jobtype_filter">
                                    ...
                                    <li>
                                        {{--                                        add new class in select field experience class--}}
                                        <select class="form-control experience_select date_filter" name="date_filter"
                                                id="date_filter">
                                    ...
                                    <li>
                                        <select class="form-control industry_select" multiple="multiple"
                                                name="industry_select" id="industry_select">
                                    ...
                                    <li>
                                        <select class="form-control experience_select" multiple="multiple"
                                                name="experience_select" id="experience_select">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="motivz-jobdetails-wrapper find-jobs-wrapper" id="motivz-jobdetails-wrapper">
                            <div class="alert alert-secondary" style="width: 100%; text-align: center;" role="alert">
                                Click on a Job to view Job Details
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{route('job.apply')}}" method="POST" enctype="multipart/form-data" name="form-job-apply"
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="text" name="email" id="email" class="form-control" placeholder="Email"
                                       @if(session::has('candidate_id'))  value="{{$candidate->email}}" readonly @endif>
                            ...
                            @else
                                <li>
                                    <label style="text-align: center;">If you have an account, please <a
                                            href="{{ route('user.login') }}" style="color: #4d9a10;
                    ...
                    <div class="modal-footer">
                        ...
                        @else
                            ...
                            <button type="button" style="display:none;" id="btn_modalpopup2" data-toggle="modal"
                                    href="#exampleModal2" class="simple-btn">Hiden
                            </button>
                        @endif
                    </div>
                </form>
    ...
    <div class="modal fade apply-popup-wrapper" id="exampleModal2" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false"
         style="overflow-x: hidden;overflow-y: auto;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="javascript:void(0)" method="POST" enctype="multipart/form-data" id="form-job-apply-code">
                    ...
                    <div class="modal-body modal-form">
                        <ul>
                            ...
                            <li>
                                <label>Resend email <a href="javascript:void(0)"
                                                       style="color: #4d9a10;font-weight: bold;" onclick="resendcode()">here</a>.
                                    If you have an account, please <a href="{{ route('user.login') }}"
                                                                      style="color: #4d9a10;font-weight: bold;">sign
                                        in</a></label>
                            </li>
                        </ul>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" style="display:none;" id="btn_modalpopup3" data-toggle="modal"
                                href="#exampleModal3" class="simple-btn">Hidden
                        </button>
                        {{--<button type="submit" class="submit" style="margin: 0px 0px;">Apply</button>--}}
                    </div>
                </form>
    ...
    <div class="modal fade apply-popup-wrapper" id="exampleModal3" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false"
         style="overflow-x: hidden;overflow-y: auto;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="javascript:void(0)" method="POST" enctype="multipart/form-data"
                      id="form-job-apply-review">
                    @csrf
                    <div class="modal-header">
                        <h5>
                    ...
                    <div class="modal-body modal-form">
                        <ul>
                            ...
                            <li>
                                <label for="terms_policy_checkbox" class="terms_policy_job_apply"><input
                                        name="terms_policy_checkbox" type="checkbox" class="terms_policy_checkbox"
                                        style="height: unset !important;" id="terms_policy_checkbox"> I have read, and I
                                    accept, MyMotivz's <a href="/contact/terms-of-use" style="color: #4d9a10">Terms of
                                        Use</a> and <a href="/contact/privacy-policy" style="color: #4d9a10">Privacy
                                        Policy</a>.</label>
                                <label id="terms_policy_checkbox-error" class="error" for="terms_policy_checkbox"
                                       style="display: none">Kindly accept the Terms of Use and Privacy Policy.</label>
                            </li>
                        </ul>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" style="display:none;" id="btn_modalpopup" data-toggle="modal"
                                href="#exampleModal" class="simple-btn">Hiden
                        </button>
                    </div>
                </form>
            </div>
                        ...
                        if (totalRe > 0) {
                            ...
                            for (var i = 0; i < myJSON.length; i++) {
                                ...
                                html += '<li class="col-md-12 side-jobs li_' + myJSON[i]['id'] + '" id="searched-jobslist" onclick=job_details(' + myJSON[i]['id'] + ')>' +
                                    ...
                                    if(myJSON[i]['client']){
                                        html += '<small>' + myJSON[i]['client']['company_name'] + '</small>';
                                    }
                                    if(myJSON[i]['admin']){
                                        html += '<small>' + myJSON[i]['mymotivz_title'] + '</small>';
                                    }
                                html += '<span class="publish"><span>' + time_ago + '</span></span>' +
        ...
        function job_details(id) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var candidate_session = '{{ Session::get('candidate_id')}}';
                    var company_session = '{{Session::get('c_email.id')}}'
                    ...
                    if (job != null) {
                        ...
                        if(job['client'])
                        {
                            if (job['client']['logo']) {
                                ...
                                html += '<span class="motivz-jobdetail-listthumb"><small style=""><img src="' + window.location.origin + '/user/images/avatar1.png" alt="Company Logo"></small></span>';
                            }
                        }
                        if(job['admin'])
                        {
                            html += '<span class="motivz-jobdetail-listthumb"><small style=""><img src="' + window.location.origin + '/'+ job['mymotivz_logo'] + '" alt="Company Logo"></small></span>';
                        }

                        html += '<figcaption>' +
                            '<h2>' + job['job_title'] + '</h2>';
                        if(job['client']){
                            html += '<a href="' + job['web_url'] + '" target="_blank"><span>' + job['client']['company_name'] + ' </span></a>';
                        }
                        else{
                            html += '<a href="' + job['web_url'] + '" target="_blank"><span>' + job['mymotivz_title'] + ' </span></a>';
                        }

                            html += '<ul class="motivz-jobdetail-options">' +
                        ...
                        if (job_check == null || job_check == '') {
                            if (company_session != '') {
                                html += '<a data-toggle="modal" id="apply_now" href="#" class="simple-btn">Apply Now</a>';
                                html += '<a href="#" class="like-wrap""><i style="' + style + '"  class="fa fa-heart"></i></a>';
                            } else {
                            ...
                            html += '<div class="applied-x"><i class="fa fa-star"></i><span>Already applied to this job</span></div>';
                        }
                        var package_to = '';
                        ...
                        if(job['admin'])
                        {
                            html_popup += '<li><i class="fa fa-building-o"></i> ' + job['mymotivz_title'] + '</li>';
                        }
                        html_popup += '<li><i class="fa fa-globe"></i> ' + job['location'] + '</li>';
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 'success') {
                        ...
                        $('#form-job-apply')[0].reset();
                        $('#form-job-apply-code')[0].reset();
                        $('#form-job-apply-review')[0].reset();
                        var text = document.createElement('div')
                        text.innerHTML = "Your application for the <b>" + job_title + "</b> job was successfully submitted. <br>Don’t have an account? <a href='{{route('user.signUp')}}' style='color:#4d9a10; font-weight:bold;'>Sign up</a> to experience our one-click apply feature."
                        sweetAlert({
                            title: "Complete!",
                            content: text,
                            icon: "success",
