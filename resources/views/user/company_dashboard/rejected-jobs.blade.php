    ...
    <div class="app-main__inner">
        ...
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                    ...
                    style="font-size: 35px; color: #4d9a10 !important;"> </i>Rejected Jobs
            </div>
        </div>
        ...
        function Paginate(length) {
            $('#example-2').pagination({
                ...
                ajax: function (options, refresh) {
                    let html = '';
                    $.ajax({
                        url: "{{route('user.client.view.job.rejected')}}",
                        type: 'post',
                        data: {
                        ...
                        for (let i = 0; i < myJSON.length; i++) {
                            ...
                            html += '<li class="col-md-12 li_' + myJSON[i]['id'] + '">' +
                                ...
                                '<h2><a href="' + window.location.origin + '/company/jobs/view-details/' + myJSON[i]['id'] + '">' + myJSON[i]['job_title'] + '</a> <span class="expired-color" style="color: black">Rejected</span></h2>' +
                                '<ul>' +
                        ...
                        if (html == "") {
                            document.getElementById('searched-jobslist').innerHTML = '<div class="alert alert-secondary" style="width: 100%; text-align: center;" role="alert">' + 'No rejected job found' + '</div>';
