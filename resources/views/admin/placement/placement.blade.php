...
<script>
    $(document).on('click','.edit_placement_btn',function () {
        ...
        $.ajax({
            ...
            var company_id = json['data'][0]['admin_client_id'];
            var job_id = json['data'][0]['admin_job_id'];
            ...
            $('#edit_hire_company_name').val(json['data'][0]['admin_client_id']);
            $('#select2-edit_hire_company_name-container').text(json['data'][0]['admin_client']['company_name']);
            $('#edit_hired_candidate').val(json['data'][0]['admin_candidate_id']);
            $('#select2-edit_hired_candidate-container').text(json['data'][0]['admin_candidate']['name']);
            var jobOp = "" ;
            $.ajax({
