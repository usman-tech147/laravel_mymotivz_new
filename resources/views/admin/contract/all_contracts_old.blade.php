...
<script>
        ...
        $('#example-3').pagination({
            ...
            ajax: function (options, refresh, $target) {
                ...
                $.ajax({
                    ...
                    // console.log(json);
                    var resume='';
                    exs = json[0]['client'][0]['contracts'][0]['status'] ;
                    // console.log(exs);
                    if(exs == 0)
                    {
                        resume += '<figure><a target="_blank" href="'+window.location.origin+'/public/files/'+json[0]['client'][0]['contracts'][0]['contract_file']+'" style="font-size: 45px; margin: 0px 10px 0px 0px;" data-toggle="tooltip" title="" class=" "  ><img id="img-'+id+'" height="50" width="50" src="'+window.location.origin+'/public/assets/images/contract_sent.png"></a></figure>'
                    }
                    else {
                        resume += '<figure><a target="_blank" href="'+window.location.origin+'/public/files/'+json[0]['client'][0]['contracts'][0]['contract_file']+'" style="font-size: 45px; margin: 0px 10px 0px 0px;" data-toggle="tooltip" title="" class="" ><img id="img-'+id+'" height="50" width="50" src="'+window.location.origin+'/public/assets/images/contract_signed.png"></a></figure>'
                    ...
                    html ='<tr>\n' +
                        ...
                        '                                                  <td id="b_address">'+json[0]['client'][0]['contracts'][0]['business_address']+'</td>\n' +
                        '                                                </tr>\n' +
                        '                                                <tr>\n' +
                        '                                                  <th>Business Phone Number:</th>\n' +
                        '                                                  <td id="b_number">'+json[0]['client'][0]['contracts'][0]['business_number']+'</td>\n' +
                        '                                                </tr>\n' +
                        '                                                <tr>\n' +
                        '                                                  <th>Position (s) looking to fill:</th>\n' +
                        '                                                  <td id="b_position">'+json[0]['client'][0]['contracts'][0]['positions']+'</td>\n' +
                        '                                                </tr>\n' +
                        '                                                <tr>\n' +
                        '                                                  <th>Number of openings:</th>\n' +
                        '                                                  <td id="b_opening">'+json[0]['client'][0]['contracts'][0]['openings']+'</td>\n' +
                        '                                                </tr>'+
                        '                                               <tr>\n' +
                        '                                                  <th>Quoted Fee:</th>\n' +
                        '                                                  <td id="b_quoted_fee">'+json[0]['client'][0]['contracts'][0]['quoted_fee']+'</td>\n' +
                        '                                                </tr>' +
                        '<tr><th>Status:</th>' +
                    '<td>' +
                    resume +
                    ...
                    var newhtml = '<a class="tag" data-client="'+json[0]['client'][0]['id']+'" data-id="'+json[0]['client'][0]['contracts'][0]['id']+'" id="contract_edit_btn" href="#editcontractformModal" data-toggle="modal">Edit</a>\n' +
                        '  @can('delete', App\contract::class) <a class="tag delete_contract" data-id="'+json[0]['client'][0]['contracts'][0]['id']+'" >Delete</a> @endcan' +
                        ''+s_btn+' ';
    ...
    $(document).on('click', '#contract_edit_btn', function() {
        ...
        $.ajax({
            ...
            $('#edit_business_address').val(json[0]['client'][0]['contracts'][0]['business_address']);
            $('#edit_business_number').val(json[0]['client'][0]['contracts'][0]['business_number']);
            ...
            $('#edit_positions').val(json[0]['client'][0]['contracts'][0]['positions']);
            $('#edit_opening').val(json[0]['client'][0]['contracts'][0]['openings']);
            $('#edit_quoted_fee').val(json[0]['client'][0]['contracts'][0]['quoted_fee']);

            if (json[0]['client'][0]['contracts'][0]['contract_file'])
            {
                var file ='';
               var  exs = json[0]['client'][0]['contracts'][0]['status'] ;
                // console.log(exs);
                if(exs == 0)
                {
                    file += '<a target="_blank" href="'+window.location.origin+'/public/files/'+json[0]['client'][0]['contracts'][0]['contract_file']+'" style="font-size: 45px; margin: 0px 10px 0px 0px;" data-toggle="tooltip" title="" class=" "  ><img id="img-'+id+'" height="50" width="50" src="'+window.location.origin+'/public/assets/images/contract_sent.png"></a>'
                }
                else {
                    file += '<a target="_blank" href="'+window.location.origin+'/public/files/'+json[0]['client'][0]['contracts'][0]['contract_file']+'" style="font-size: 45px; margin: 0px 10px 0px 0px;" data-toggle="tooltip" title="" class="" ><img id="img-'+id+'" height="50" width="50" src="'+window.location.origin+'/public/assets/images/contract_signed.png"></a>'
