            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <form id="client-validation" method="post" action="{{route('client.created')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="job_title" value="{{ old('job_title') }}" type="text"
                                                   class="form-control" placeholder="">
                                            @error('job_title')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input name="email" id="email-client" type="email"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="optional">Website Address
                                                <small>(http://www.example.com)</small></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="industry" value="{{ old('industry') }}" type="text"
                                                   class="form-control" placeholder="">
                                            @error('industry')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                ...
                                <!-- value="{{ old('recruitment_pipeline') }}" -->
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-checkbox custom-control" style="margin-bottom: 10px;">
                                            <input name="recruitment_pipeline" value="1" type="checkbox" id="a"
