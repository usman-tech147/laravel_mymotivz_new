                                      ...
                                      <form action="">
                                        <ul class="search-form">
                                          <li>
                                              ...
                                              <select onchange="search_job()" name="client" id="rej_company_id_interview" class="multiselect-dropdown form-control client-list-check">
                                          ...
                                          <li>
                                              ...
                                              <select class="multiselect-dropdown job_title form-control"  name="job_title"  id="rej_job_interview">
                                                  <option value="" style="display: none;"></option>
                                              </select>
                                          </li>
                                          <li>
                                              <button id="rej_search_interview" type="button" class="btn btn-primary pull-left" style="margin: 27px 0 0;">Search</button>
                                          </li>
                                        </ul>
                                      </form>
                                    </div>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="table-responsive otm table-otm">
                                            <table style="width: 100%;" id="rejected_scheduled_interviews" class="table table-hover table-striped table-bordered table-cursor">
                                                <thead>
                                                    <tr>
                                                        <th>Company Name</th>
                                                        <th>Job</th>
