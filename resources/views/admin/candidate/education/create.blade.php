    ...
    <div class="app-main__inner">
        ...
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                    class="pe-7s-user mr-3 text-muted opacity-6" style="font-size: 35px; color: white !important;"> </i>Candidate
                Education
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="education_name" name="name" type="text" class="form-control"
                                               placeholder="">
                                        <div class="error" style="display: none;">The field can't be empty</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <button style="margin: 31px 0 0;" id="educationSubmit" type="button"
                                            class="btn btn-primary pull-left">Create Now
                                    </button>
                                </div>
                            </div>
        ...
        function status() {
            ...
            $.ajax({
                ...
                for (let i = 0; i < json.length; i++) {
                    ...
                    //         '                                    <td>' + index + '</td>\n' +
                    //         '                                    <td id="spanVal-' + json[i]['id'] + '" >' + json[i]['name'] + '</td>\n' +
                    //         '                                    <td><a data-toggle="modal" data-id="' + json[i]['id'] + '" class="tag education-edit" href="#eduactionModal">Edit</a> ' +
                    //         '<a data-id="' + json[i]['id'] + '" class="tag stts-del" href="#">Delete</a>\n' +
                    //         '                                    </td>\n' +
                    //         '                                </tr>';
                    // }
