                            ...
                            <form action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 del">
                                        <button onclick="Fun(25)" style="margin: 0px;" type="button"
                                ...
                                <div class="motivz-job-search can-adv-srch">
                                    <ul>
                                        ...
                                        <li><input onclick="Fun(25)" type="button" class="btn btn-primary pull-left"
                                                   value="Search"></li>
                                    </ul>
                                </div>
                            </form>
            ...
            $.ajax({
                ...
                .done(function (response) {
                    ...
                    html1 = '<a class="tag" data-toggle="modal" href="#statusModal">Update Status</a>' +
                        ...
                        '</a> @can('delete', \App\Models\Admin\AdminCandidate::class)<a dataId="' + myJSON[0]['id'] + '" class="tag del-cand" href="#">Delete' +
